    ...
    <div className="group rounded-md hover:bg-accent/30 transition-colors">
      <div className="flex items-center justify-between px-2 py-1">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-[10px] text-muted-foreground/60">{column.data_type}</span>
          {column.key && (
      ...
      <div
        className={`px-2 pb-1 text-xs ${isNull ? 'text-muted-foreground italic' : 'text-foreground/80'} ${
