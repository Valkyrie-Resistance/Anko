...
INSERT INTO inventory_items (sku, name, description, category_id, supplier_id, unit_of_measure, unit_cost, reorder_level, reorder_quantity, lead_time_days, specifications, metadata) VALUES
('PCB-001', 'Main Controller Board v2.1', '8-layer PCB for main controller unit', 2, 1, 'UNIT', 45.00, 100, 500, 14,
  '{"layers": 8, "dimensions_mm": {"length": 100, "width": 80}, "copper_weight_oz": 2, "surface_finish": "ENIG", "min_trace_width_mm": 0.15}',
  '{"revision": "2.1", "rohs_compliant": true, "lead_free": true, "certifications": ["UL", "CE"]}'),
('PCB-002', 'Power Supply Board', '4-layer PCB for power management', 2, 1, 'UNIT', 22.50, 150, 600, 14,
  '{"layers": 4, "dimensions_mm": {"length": 60, "width": 40}, "copper_weight_oz": 2, "surface_finish": "HASL", "voltage_rating_v": 48}',
  '{"revision": "1.3", "rohs_compliant": true, "lead_free": true}'),
('CHIP-001', 'ARM Cortex M4 Processor', 'STM32F4 series microcontroller', 3, 1, 'UNIT', 8.75, 500, 2000, 21,
  '{"core": "ARM Cortex-M4", "clock_mhz": 168, "flash_kb": 512, "ram_kb": 128, "gpio_pins": 82, "adc_channels": 16}',
  '{"part_number": "STM32F407VGT6", "package": "LQFP100", "temperature_range": {"min_c": -40, "max_c": 85}}'),
('CHIP-002', 'WiFi Module ESP32', 'Dual-core WiFi/BT module', 3, 1, 'UNIT', 4.50, 1000, 5000, 21,
  '{"cores": 2, "clock_mhz": 240, "wifi": {"standards": ["802.11b", "802.11g", "802.11n"], "frequency_ghz": 2.4}, "bluetooth": "5.0", "flash_mb": 4}',
  '{"part_number": "ESP32-WROOM-32E", "antenna": "PCB", "certifications": ["FCC", "CE", "IC"]}'),
('FAST-001', 'M3x8 Stainless Screws', 'Stainless steel Phillips head', 5, 2, 'BOX/100', 12.00, 50, 200, 7,
  '{"thread_size": "M3", "length_mm": 8, "head_type": "Phillips", "material": "304 Stainless Steel", "drive_size": "#1"}',
  '{"finish": "plain", "thread_pitch_mm": 0.5}'),
('FAST-002', 'M4x12 Hex Bolts', 'Grade 8.8 hex head bolts', 5, 2, 'BOX/50', 18.00, 40, 150, 7,
  '{"thread_size": "M4", "length_mm": 12, "head_type": "Hex", "material": "Alloy Steel", "grade": "8.8"}',
  '{"finish": "zinc plated", "thread_pitch_mm": 0.7, "wrench_size_mm": 7}'),
('BEAR-001', '6201 Ball Bearing', 'Deep groove ball bearing 12x32x10mm', 6, 3, 'UNIT', 3.25, 200, 1000, 10,
  '{"type": "deep groove", "inner_dia_mm": 12, "outer_dia_mm": 32, "width_mm": 10, "dynamic_load_kn": 6.89, "static_load_kn": 3.1}',
  '{"seal_type": "2RS", "material": "chrome steel", "lubrication": "grease"}'),
('BEAR-002', '6205 Ball Bearing', 'Deep groove ball bearing 25x52x15mm', 6, 3, 'UNIT', 5.50, 150, 800, 10,
  '{"type": "deep groove", "inner_dia_mm": 25, "outer_dia_mm": 52, "width_mm": 15, "dynamic_load_kn": 14.8, "static_load_kn": 7.8}',
  '{"seal_type": "2RS", "material": "chrome steel", "lubrication": "grease"}'),
('BOX-001', 'Small Shipping Box', '200x150x100mm corrugated', 8, 5, 'BUNDLE/25', 8.50, 100, 500, 3,
  '{"dimensions_mm": {"length": 200, "width": 150, "height": 100}, "material": "corrugated cardboard", "wall_type": "single", "ect_rating": 32}',
  '{"recyclable": true, "flat_packed": true}'),
('BOX-002', 'Medium Shipping Box', '300x250x200mm corrugated', 8, 5, 'BUNDLE/25', 14.00, 80, 400, 3,
  '{"dimensions_mm": {"length": 300, "width": 250, "height": 200}, "material": "corrugated cardboard", "wall_type": "single", "ect_rating": 32}',
  '{"recyclable": true, "flat_packed": true}'),
('BOX-003', 'Large Shipping Box', '500x400x300mm corrugated', 8, 5, 'BUNDLE/10', 22.00, 50, 200, 3,
  '{"dimensions_mm": {"length": 500, "width": 400, "height": 300}, "material": "corrugated cardboard", "wall_type": "double", "ect_rating": 48}',
  '{"recyclable": true, "flat_packed": true, "max_weight_kg": 30}'),
('MTL-001', 'Aluminum Sheet 2mm', '1000x500mm aluminum plate', 10, 4, 'SHEET', 35.00, 30, 100, 14,
  '{"alloy": "6061-T6", "thickness_mm": 2, "dimensions_mm": {"length": 1000, "width": 500}, "surface": "mill finish"}',
...
('MTL-002', 'Steel Rod 10mm', '1m length steel rod', 10, 4, 'UNIT', 8.00, 100, 500, 14,
  '{"grade": "1045", "diameter_mm": 10, "length_m": 1, "surface": "bright drawn"}',
  '{"density_g_cm3": 7.85, "tensile_strength_mpa": 585, "hardness_hrc": 20}');
